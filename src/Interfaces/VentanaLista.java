...
import Interfaces.Modelos.FrecuenciaPalabrasTableModel;
...
public class VentanaLista extends javax.swing.JFrame {
     ...
     */
    public VentanaLista() {
        this(new ListaEnlazada());
    }

    public VentanaLista(ListaEnlazada listaEnlazada) {
    ...
    private void initComponents() {
        ...
        setTitle("Tabla de Frecuencias - Verificador de ArtÃ­culos Code4U");

        titulo.setText("Frecuencia de palabras en el texto");

        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);

        tablaFrecuencia.setModel(new FrecuenciaPalabrasTableModel(listaEnlazada));
        jScrollPane1.setViewportView(tablaFrecuencia);
